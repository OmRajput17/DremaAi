...
from .prompt_generator import generate_cbse_prompt, generate_general_prompt, generate_summary_prompt, generate_flashcard_prompt, generate_mindmap_prompt, generate_study_tricks_prompt, generate_answer_prompt
